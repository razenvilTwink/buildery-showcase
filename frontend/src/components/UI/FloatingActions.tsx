  ...
  return (
    <div className={cn('fixed bottom-6 right-6 z-40 flex flex-col gap-3', className)}>
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white rounded-full px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2"
        aria-label="Написать в WhatsApp"
      >
        <MessageCircle className="h-6 w-6" />
        <span className="text-sm font-medium">Написать в WhatsApp</span>
      </button>
