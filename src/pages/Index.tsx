...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Строительство домов под ключ в Ставропольском крае | Строй Мечту</title>
        <meta name="description" content="Строительство современных домов и коттеджей под ключ в Ставрополе и крае. Индивидуальный подход, фиксированная стоимость, гарантия качества." />
        <meta property="og:title" content="Строительство домов под ключ | Строй Мечту" />
        <meta property="og:description" content="Строим современные дома и коттеджи под ключ в Ставропольском крае. Индивидуальный подход, гарантия качества." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ваш-домен.рф/" />
        <meta property="og:image" content="/public/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Строительство домов под ключ | Строй Мечту" />
        <meta name="twitter:description" content="Строим современные дома и коттеджи под ключ в Ставропольском крае. Индивидуальный подход, гарантия качества." />
