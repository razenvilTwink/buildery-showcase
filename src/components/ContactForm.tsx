            ...
            <div className="bg-construction-sand/30 p-8 rounded-xl">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-medium text-construction-dark">г. Москва, ул. Строителей, д. 10, офис 505</p>
                </div>
                
                <div>
                  <p className="text-sm text-construction-medium mb-1">Телефон:</p>
                  <a href="tel:+79991234567" className="font-medium text-construction-dark hover:text-construction-light transition-colors">
                    +7 (999) 123-45-67
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a href="mailto:info@gorizont-stroy.ru" className="font-medium text-construction-dark hover:text-construction-light transition-colors">
                    info@gorizont-stroy.ru
                  </a>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="privacy" className="ml-2 block text-sm text-construction-medium">
                  Я согласен с <a href="#" className="text-construction-dark hover:underline">политикой конфиденциальности</a>
                </label>
              </div>
